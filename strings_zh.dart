...
const Map<String, String> stringsZh = {
  ...
  'showUnrevealedCounter': '显示未揭开格子计数器',
  'showUnrevealedCounterDesc': '在游戏界面显示未揭开格子的数量',
  'showMineCounter': '显示地雷计数器',
  'showMineCounterDesc': '在游戏界面显示剩余地雷数',
  ...
  // Counter strings
  'currentLevel': '当前关次',
  'remainingMines': '剩余地雷数量',
  'unrevealedCells': '未揭开格子数量',
  'gameTime': '游戏用时（秒）',
  'operationCount': '操作次数',
  'previousLevel': '上一关',
  'nextLevelShort': '下一关',
